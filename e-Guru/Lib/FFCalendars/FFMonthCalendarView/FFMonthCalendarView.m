...
@synthesize dictEvents,exclusionViewModel;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        collectionViewMonth = [[FFMonthCollectionView alloc] initWithFrame:CGRectMake(0., HEADER_HEIGHT_MONTH, self.frame.size.width, self.frame.size.height-HEADER_HEIGHT_MONTH-130) collectionViewLayout:[UICollectionViewLayout new]];
//        collectionViewMonth = [[FFMonthCollectionView alloc] initWithFrame:CGRectMake(0., HEADER_HEIGHT_MONTH, self.frame.size.width, self.frame.size.height-HEADER_HEIGHT_MONTH-250) collectionViewLayout:[UICollectionViewLayout new]];
        [collectionViewMonth setProtocol:self];
        [self addSubview:collectionViewMonth];
        
        [self setAutoresizingMask: AR_WIDTH_HEIGHT];
        [collectionViewMonth setAutoresizingMask:AR_WIDTH_HEIGHT ];
...
- (void)setExclusionViewModel:(EGExclusionViewModel *)_exclusionViewModel {
    exclusionViewModel = _exclusionViewModel;
    [collectionViewMonth setExclusionViewModel:_exclusionViewModel];
